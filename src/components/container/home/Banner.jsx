            ...
            <div className="container py-20 md:py-8">
                <div className="flex flex-wrap justify-between items-center space-y-6">
                    <div className="w-full md:w-1/2 space-y-6">
                        <Heading as="h1" className="text-3xl text-white font-normal">
                            Discover top brands, exclusive deals, and everything
                            you need — all in one place.
                        </Heading>
                        <Link to="/shop" className="block">
                            <Button className="bg-white text-accent transition-colors duration-400 hover:bg-accent hover:text-white">Shop Now</Button>
                        </Link>
                    </div>
